...
SCHEMA = [
    ...
    ("section_manuals", "Раздел «Мануалы» включён", "bool", "1", "Разделы"),
    ("section_traffic", "Раздел «Закуп трафика» включён", "bool", "1", "Разделы"),
    ("section_partner", "Раздел «Партнёрка» включён", "bool", "1", "Разделы"),
    ("section_billing", "Раздел «Подписка» включён", "bool", "1", "Разделы"),
    ...
    ("form_note", "Пояснение к форме заявки", "text",
     "Клиент сам вводит ИНН и ФИО, заявка создаётся от вашего имени, затем клиент переходит на оффер.", "Партнёрка"),
    ...
    ("traffic_price", "Цена за строку трафика, ₽", "money", "15", "Трафик"),
    ("traffic_format", "Формат строки трафика", "str", "номер, id, user, последняя активность", "Трафик"),
    ("topup_instructions", "Инструкция по пополнению баланса", "text",
     "Переведите сумму по реквизитам и отправьте заявку — администратор зачислит средства после проверки.", "Трафик"),
